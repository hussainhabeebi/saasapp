...
ALTER TABLE live_travel_bookings ADD COLUMN hold_ref TEXT NOT NULL DEFAULT '';
ALTER TABLE live_travel_offers ADD COLUMN checkout_url TEXT NOT NULL DEFAULT '';
